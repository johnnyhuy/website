...
Simple rule: if progress time or touched files exceed your mental estimate, interrupt immediately and ask for a status update. Keeps the agent aligned. Prevents it from "solving the wrong problem correctly."
