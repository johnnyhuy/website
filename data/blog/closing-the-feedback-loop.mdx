...
What makes it work: real data from Slack/Confluence/Jira. Contradiction detection flags when sources disagree. Iterative refinement means I keep correcting until it's accurate.
