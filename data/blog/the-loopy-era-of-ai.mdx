...
That is Andrej Karpathy's description of his own workflow shift beginning around December 2025. It sounds extreme until you've spent a week running multiple agent sessions in parallel, each handling a discrete chunk of work, while you review and redirect.
...
[AutoResearch](http://github.com/karpathy/autoresearch) applies this pattern to AI research by letting agents modify training code, run experiments, and retain only improvements.
