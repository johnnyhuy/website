<script lang="typescript">
  ...
  import Special from "./routes/home/Special.svx";
...
<div>
  <header class="container mx-auto flex flex-row py-8">
    ...
    <nav
      ...
      <a href="about" class="hover:text-gray-500 px-6">
        <span class="align-middle">Projects</span>
      </a>
      <a href="blog" class="hover:text-gray-500 px-6">
  ...
  <div class="landing flex relative container mx-auto font-semibold">
    <div class="absolute w-full h-full">
      <div class="dark-cloud-pair">
        ...
        <div class="relative">
          ...
          <div
            style="background-color: #455577; left: 240px; top: -30px"
            class="absolute inline-block p-4 rounded-full shadow-lg">
            <img
          ...
          <div
            style="background-color: #F3F7FB; left: 240px; top: 90px"
            class="absolute inline-block p-4 rounded-full shadow-lg">
            <img src="/images/logos/azure.svg" alt="johnny" class="w-12 h-12" />
          </div>
          <div
            style="background-color: #F4FFFE; left: 200px; top: 200px"
            class="absolute inline-block p-4 rounded-full shadow-lg">
            <img src="/images/logos/figma.svg" alt="johnny" class="w-12 h-12" />
          </div>
          <div
            style="background-color: #FFF4F4; left: 90px; top: 240px"
            class="absolute inline-block p-4 rounded-full shadow-lg">
            <img
          ...
          <div
            style="background-color: #4B4841; left: -30px; top: 240px"
            class="absolute inline-block p-4 rounded-full shadow-lg">
    ...
    <div class="relative z-50 mt-20">
      <p class="text-4xl">
        a
        <span
          class="inline-block px-3 py-2 rounded-xl bg-amber-600 text-white">Cloud</span>
        engineer
      </p>
      ...
      <a
        ...
        class="github text-xl mr-4"><Icon
          name="github-outline"
          class="w-6 h-6 align-middle mr-2" /><span
          class="align-middle">GitHub</span></a>
      <a
        target="_blank"
        href="https://www.linkedin.com/in/johnnyhuy/"
        class="linkedin text-xl"><Icon
          name="linkedin-outline"
          class="w-6 h-6 align-middle mr-2" /><span
          class="align-middle">LinkedIn</span></a>
    </div>
  </div>
  <div class="special">
    <div class="relative">
